package org.phantam.fozminespoofcore.commands;
...
import org.phantam.fozminespoofcore.commands.subcommands.*;
...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public CommandManager(FozmineSpoofCore plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            plugin.getLogger().severe("Error executing subcommand '/spoof " + subName + "':");
            e.printStackTrace();
