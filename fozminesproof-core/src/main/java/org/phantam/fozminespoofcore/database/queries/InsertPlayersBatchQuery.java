...
/**
 * Batch inserts or updates multiple fake player records.
 */
public class InsertPlayersBatchQuery implements Query<Void> {

    private final String tableName;
    private final Collection<FakePlayerData> players;

    public InsertPlayersBatchQuery(String tableName, Collection<FakePlayerData> players) {
