...
/**
 * Packet broadcaster for fake player presence and tablist latency updates in 26.2.
 */
public class FakePlayerPacketSender {
    ...
    public void sendSpawnPackets(ServerPlayer fakePlayer, String name, boolean hideTab) {
        ...
        // Construct spawn packet using the public 11-parameter constructor with fakePlayer.getType()
